...
[task_local]
#真快乐天天任务
00 00 8 * * * jd_speed_sign.js, tag=真快乐天天任务, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "00 00 2,14 * * *" script-path=jd_speed_sign.js,tag=真快乐天天任务

===============Surge=================
真快乐天天任务 = type=cron,cronexp="00 00 8 * * *",wake-system=1,timeout=33600,script-path=jd_speed_sign.js

============小火箭=========
真快乐天天任务 = type=cron,script-path=jd_speed_sign.js, cronexpr="00 00 8 * * *", timeout=33600, enable=true
*/

const $ = new Env('真快乐天天任务');
var appUrlArr = [];
var Cookie2 = '';
var ZklUrl = "";
