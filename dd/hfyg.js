...
[task_local]
#美团5号
00 00 8,10 * * * jd_speed_sign.js, tag=美团5号, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "00 00 8,10 * * *" script-path=jd_speed_sign.js,tag=美团5号

===============Surge=================
美团5号 = type=cron,cronexp="00 00 8,10 * * *",wake-system=1,timeout=33600,script-path=jd_speed_sign.js

============小火箭=========
美团5号 = type=cron,script-path=jd_speed_sign.js, cronexpr="00 00 8,10 * * *", timeout=33600, enable=true
*/
